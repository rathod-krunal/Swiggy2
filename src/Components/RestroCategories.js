...
const RestroCategories = () => {
  ...
  return (
    <div className="restroCategoriesmain">
      ...
      <div className="restroPriceDiv">  <BsCurrencyRupee className="rupeesIcon"/>{costForTwo/100} For Two</div>
      <div className="offersdiv">
    {offers.map((offer)=>{
      return(
       <div className="offers" key={offer.info.header}>
        <div className="topOffer"> <img src={MENU_OFFERS_LOGO + offer.info.offerLogo} alt="" />{offer.info.header} </div>
